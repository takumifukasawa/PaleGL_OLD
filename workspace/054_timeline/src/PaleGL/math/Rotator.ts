...
export class Rotator {
    ...
    get x() {
        ...
        return this.quaternion.toEulerDegree().x;
    }

    // degree
    get y() {
        // return this.elements[1];
        return this.quaternion.toEulerDegree().y;
    }

    // degree
    get z() {
        // return this.elements[2];
        return this.quaternion.toEulerDegree().z;
    }

    // degree
    set x(v: number) {
        // this.elements[0] = v;
        const euler = this.quaternion.toEulerDegree();
        euler.x = v;
    ...
    getAxesRadians() {
        ...
        // };
        const radian = this.quaternion.toEulerRadian();
        return {
            x: radian.x,
            y: radian.y,
            z: radian.z,
